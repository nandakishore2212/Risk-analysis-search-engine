...
session_start();
    ...
    $output= shell_exec('python D:\software\xampp\htdocs\ProjectModel\defnrel.py '.$cuicode);
    echo $output;  
    ...
    //            $string_version = implode(',', $original_array)
        ...
        fclose($myfile2); 
        echo "<br><h1 style='color:green'>The XML file has been updated and saved as 'filenameversion2.xml'".'<a href="http://localhost/ProjectModel/tree.php">Click here to return to the ADD GMDN data page</a></h1>';
        }
        else{

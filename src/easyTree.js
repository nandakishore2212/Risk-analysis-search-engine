...
(function ($) {
    $.fn.EasyTree = function (options) {
        ...
        var createInput = $('<div class="input-group"><input type="text" name="device" class="form-control"><span class="input-group-btn"><button onclick="addCancelClicked()" type="button" class="btn btn-default btn-success confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-default cancel"></button> </span> </div> ');
        
        var createAssembly = $('<div class="input-group"><input type="text" name="assembly" class="form-control"><span class="input-group-btn"><button onclick="addCancelClicked()" type="button" class="btn btn-default btn-success confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-default cancel"></button> </span> </div> ');
        
        var createComponent = $('<div class="input-group"><input type="text" name="component" class="form-control"><span class="input-group-btn"><button onclick="addCancelClicked()" type="button" class="btn btn-default btn-success confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-default cancel"></button> </span> </div> ');
        var createInteraction = $('<div class="input-group"><input type="text" name="interaction" class="form-control"><span class="input-group-btn"><button type="button" onclick="addCancelClicked()" class="btn btn-default btn-success confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-default cancel"></button> </span> </div> ');
        
        var createAttributes = $('<div class="input-group"><input type="text" name="attributes" class="form-control"><span class="input-group-btn"><button type="button" onclick="addCancelClicked()" class="btn btn-default btn-success confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-default cancel"></button> </span> </div> ');

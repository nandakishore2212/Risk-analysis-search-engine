...
echo $twig->render('myUploadPage.twig');
...
// retreive info from the form
     ...
     // $filename = $_POST['filename'];
      ...
      $query = "insert into temp_models(filename,tempname,filetype,description,user)values('".$filename."', '".$tempname."', '".$filetype."', '".$description."','".$user."')";
      mysql_query($query);
